...
This file intentionally preserves the Gate A Representation v0 semantics.
...
- `distinct` means outcomes must remain observably distinguishable.
...
No inference beyond these semantics is part of Representation v0.
