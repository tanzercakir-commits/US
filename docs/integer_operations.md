...
`codeskeptic.fixed-integer-phase-gate/v0`. It records:
...
- all 16 immutable v1 archive hashes and five v1-to-v2 status-equivalent cases.
...
the same 18 artifact byte set. Any count, hash, status, lane, or capability
