...
`codeskeptic.fixed-integer-phase-gate/v3`. It records:
...
- all 16 immutable v1, 28 immutable v2, 31 immutable v3, and 34 immutable v4
  archive hashes, plus five v1-to-v5, nine v2-to-v5, ten v3-to-v5, and eleven
  v4-to-v5 status-equivalent cases.
...
the same 24 artifact byte set. Any count, hash, status, lane, or capability
